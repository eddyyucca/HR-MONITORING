...
@section('page-title')
  <i class="fas fa-user-plus text-primary"></i> Tambah Kandidat Rekrutmen
@endsection
@section('breadcrumb')
...
<form method="POST" action="{{ route('rekrutmen.store') }}">
            ...
            <div class="col-6">
              <div class="form-group">
                ...
                <input type="text" name="no_telp" class="form-control"
                  value="{{ old('no_telp') }}" placeholder="08xx">
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
          ...
          <div class="row">
            ...
            <div class="col-6">
              <div class="form-group">
                ...
                <input type="text" name="user_pic" class="form-control" value="{{ old('user_pic') }}" placeholder="Nama PIC">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                ...
                <input type="date" name="date_approved" class="form-control" value="{{ old('date_approved') }}">
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label>Date Progress</label>
                <input type="date" name="date_progress" class="form-control" value="{{ old('date_progress') }}">
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <input type="number" name="sla" class="form-control"
              value="{{ old('sla') }}" min="0" step="0.5" placeholder="Jumlah hari SLA">
          </div>
          <div class="form-group">
            <label>Remarks</label>
            <textarea name="remarks" class="form-control" rows="3" placeholder="Catatan...">{{ old('remarks') }}</textarea>
          </div>
        </div>
      </div>
  ...
  <div class="d-flex justify-content-end mt-2">
    <a href="{{ route('rekrutmen.index') }}" class="btn btn-secondary btn-sm mr-2">
